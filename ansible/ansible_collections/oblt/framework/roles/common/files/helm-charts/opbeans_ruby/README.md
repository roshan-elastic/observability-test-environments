# Opbeans Ruby Helm chart

Opbeans Ruby Helm chart deploy the [Opbeans Ruby](https://github.com/elastic/opbeans-ruby/)
and all services needed (PostgreSQL, Redis, and Elasticseacrh).

## Parameters

### opbeans Opbeans Ruby Helm chart configuration
...
| Name                       | Description                                                                              | Value                                             |
| -------------------------- | ---------------------------------------------------------------------------------------- | ------------------------------------------------- |
| `opbeans.image.name`       | Name of the Docker image (docker.elastic.co/observability-ci/it_opbeans-frontend_nginx). | `docker.elastic.co/observability-ci/opbeans-ruby` |
...
| `opbeans.apm.serviceName`      | Name of the service deploy for the Helm chart (APM spans).    | `opbeans-ruby`                   |
...
| `opbeans.db.host`     | Database host.                      | `opbeans-ruby-db` |
| `opbeans.db.name`     | Database name.                      | `opbeans-ruby`    |
...
| `opbeans.ingress.host`              | Hostname exposed by the ingress resource.      | `opbeans-ruby.127.0.0.1.ip.es.io` |
...
| Name                   | Description   | Value                                    |
| ---------------------- | ------------- | ---------------------------------------- |
| `opbeans.redis.url`    | Redis URL.    | `redis://opbeans-ruby-redis-master:6379` |
| `opbeans.volumeMounts` | Volume mounts | `undefined`                              |
| `opbeans.volumes`      | Volumes       | `undefined`                              |

### postgresql PostgreSQL Helm chart configuration

| Name                          | Description                                                                                     | Value             |
| ----------------------------- | ----------------------------------------------------------------------------------------------- | ----------------- |
| `postgresql.fullnameOverride` | Overrides the the Helm Chart fullname used to naming kubernetes objects, by default `opbeanst`. | `opbeans-ruby-db` |
...
| Name                     | Description                                                                                     | Value                |
| ------------------------ | ----------------------------------------------------------------------------------------------- | -------------------- |
| `redis.fullnameOverride` | Overrides the the Helm Chart fullname used to naming kubernetes objects, by default `opbeanst`. | `opbeans-ruby-redis` |
