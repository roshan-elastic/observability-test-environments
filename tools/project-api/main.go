...
import (
	...
	spec "github.com/elastic/observability-test-environments/tools/project-api/pkg/api/user"
)
...
func main() {
	...
	params := spec.ListElasticsearchProjectsParams{}
	if err == nil {
		client.ListElasticsearchProjects(context.TODO(), &params, reqOptions)
	}
}
