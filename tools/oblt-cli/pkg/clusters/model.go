...
// NewClusterConfig creates a new ClusterConfigSchemaJson from a YamlFile
func NewClusterConfig(clusterConfig files.YamlFile) (config *api.ClusterConfig, err error) {
	var jsonString []byte
	config = &api.ClusterConfig{}
	jsonString, err = json.Marshal(maps.InterfaceToMapInterface(clusterConfig.Data))
	if err == nil {
